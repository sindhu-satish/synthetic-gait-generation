...
def evaluate_real_vs_synthetic(real_windows, synth_windows, sensor_type: str, save_dir: str, seed=42):
    ...
    print(f"Real vs Synthetic Classifier Results ({sensor_type}):")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_dir, f"real_vs_synth_classifier_{sensor_type.lower()}.png"), dpi=150, bbox_inches="tight")
    plt.close()
